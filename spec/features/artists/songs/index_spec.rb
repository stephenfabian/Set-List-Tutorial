...
RSpec.describe 'Artists songs index' do
  before :each do 
    ...
    @beret = @prince.songs.create!(title: 'Rasberry Beret', length: 665, play_count: 99)
  end
  ...
  it 'linkes to each songs show page' do
  ...
  it 'shows the average song length for the artist do' do
